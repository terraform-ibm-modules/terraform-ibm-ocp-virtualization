...
| <a name="module_vpc"></a> [vpc](#module\_vpc) | terraform-ibm-modules/landing-zone-vpc/ibm | 7.23.13 |
...
| <a name="input_region"></a> [region](#input\_region) | Region where the all cluster resources will be provisioned. | `string` | `"us-south"` | no |
