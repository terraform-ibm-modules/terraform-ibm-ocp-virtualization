...
| <a name="input_address_prefix"></a> [address\_prefix](#input\_address\_prefix) | OPTIONAL - IP range that will be defined for the VPC for a certain location. Use only with manual address prefixes | `string` | `"10.10.10.0/24"` | no |
...
| <a name="input_region"></a> [region](#input\_region) | Region to provision all resources created by this example | `string` | `"ca-tor"` | no |
...
| <a name="input_zone"></a> [zone](#input\_zone) | value | `number` | `2` | no |
